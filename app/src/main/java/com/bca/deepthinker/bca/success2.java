...
public class success2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category.add(new Category_List("Android","Description",R.drawable.androidlogo));
        category.add(new Category_List("Web Design","Description",R.drawable.webdes));
        category.add(new Category_List("Web Dev","Description",R.drawable.webdev));
        category.add(new Category_List("Desktop App","Description",R.drawable.desktopapp));
        category.add(new Category_List("Games","Description",R.drawable.gamingdev));


        RecyclerView myrv=(RecyclerView)findViewById(R.id.all_users_post_list);
        RecyclerViewAdapter2 myAdapter= new RecyclerViewAdapter2(this,category);
        ...
        actionBarDrawerToggle=new ActionBarDrawerToggle(success2.this,drawerLayout, R.string.drawer_open,R.string.drawer_close);
    ...
    {
        Intent loginIntent= new Intent(success2.this,Login_form.class);
    ...
    //{
    // final AlertDialog.Builder builder=new AlertDialog.Builder(success2.this);
    ...
    //}
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.nav_profile:
                Intent i=new Intent(success2.this,UserProfile.class);
                startActivity(i);
                break;
            ...
            case R.id.nav_message:
                if (IdHelper.Seller){
                    ...
                    Intent messadeIntent = new Intent(success2.this, MessageListActivity.class);
            ...
            case R.id.nav_seller:
                if (IdHelper.Seller){
                    ...
                    Intent mainIntent = new Intent(success2.this, success2.class);
